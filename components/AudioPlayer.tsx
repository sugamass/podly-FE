...
export default function AudioPlayer({ uri, imageUrl, isActive }: AudioPlayerProps) {
      ...
      {!isLoading && (
        <View style={styles.controlsOverlay}>
          ...
          <View style={styles.controls}>
            ...
            >
              <Ionicons name="play-skip-back" size={24} color={Colors.dark.text} />
            ...
            >
              {isPlaying ? (
                <Ionicons name="pause" size={30} color={Colors.dark.background} />
              ) : (
                <Ionicons name="play" size={30} color={Colors.dark.background} />
              )}
            </TouchableOpacity>
            ...
            >
              <Ionicons name="play-skip-forward" size={24} color={Colors.dark.text} />
              <Text style={styles.skipText}>15s</Text>
            </TouchableOpacity>
          </View>
        </View>
